                    ...
                    <form method="POST" id ="form_reset" action="/sendmail">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="width:230px;background-color:black;border:2px solid black;">
                                    Envoyer
                                </button>
                            </div>
                            <br/>
                            @if (session('error'))
                                <div class="alert alert-danger" role="alert" id="alerts" style="">
	                            {{ session('error') }}
                                </div>
